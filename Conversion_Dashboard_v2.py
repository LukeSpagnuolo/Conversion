...
def update_graphs(selected_sports, filter_2026, selected_years, prog_filter):
    ...
    fig_ts.update_layout(
        ...
        yaxis2=dict(title="Avg Yrs Targeted", overlaying="y", side="right",
                    anchor="free", position=0.88, showgrid=False, gridcolor="#444"),
        yaxis3=dict(title="Conv. Rate (%)", overlaying="y", side="right",
                    anchor="free", position=1.0, tickformat=".0f", gridcolor="#444", showgrid=False),
        ...
        margin=dict(l=40, r=150, t=50, b=100),
        hovermode='x unified',
        autosize=True,
    )
